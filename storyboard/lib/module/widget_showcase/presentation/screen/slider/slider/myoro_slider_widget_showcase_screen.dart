...
final class MyoroSliderWidgetShowcaseScreen extends StatelessWidget {
  ...
  const MyoroSliderWidgetShowcaseScreen({super.key});

  @override
  Widget build(_) {
    return InheritedProvider(
      create: (_) => MyoroSliderWidgetShowcaseScreenViewModel(),
