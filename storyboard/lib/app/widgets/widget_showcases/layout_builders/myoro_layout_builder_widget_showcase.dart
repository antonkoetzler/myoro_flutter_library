...
final class _Widget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final textStyle = context.resolveThemeExtension<MyoroLayoutBuilderWidgetShowcaseThemeExtension>().textStyle;
...
final class _Description extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final themeExtension = context.resolveThemeExtension<MyoroLayoutBuilderWidgetShowcaseThemeExtension>();
