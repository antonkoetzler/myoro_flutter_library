...
final class _Widget extends StatelessWidget {
  ...
  MyoroTablePagination<String> _paginationBuilder(_) {
    return MyoroTablePagination(
      items: List.generate(faker.randomGenerator.integer(100), (int index) => '#$index: ${faker.lorem.word()}'),
      totalPages: faker.randomGenerator.integer(9999),
      acceptedItemsPerPage: List.generate(faker.randomGenerator.integer(10, min: 2), (int index) => index + 5).toSet(),
    );
  }
