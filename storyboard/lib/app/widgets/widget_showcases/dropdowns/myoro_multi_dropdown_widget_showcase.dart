...
final class _Widget extends StatelessWidget {
  ...
  void _checkboxOnChanged(BuildContext context, bool enabled, List<String>? item) {
    context.showSnackBar(
      snackBar: MyoroSnackBar(
    ...
    return BlocBuilder<MyoroDropdownWidgetShowcasesBloc, MyoroDropdownWidgetShowcasesState>(
      builder: (_, MyoroDropdownWidgetShowcasesState state) {
        return MyoroMultiDropdown<String>(
          ...
          checkboxOnChanged: state.checkboxOnChangedEnabled ? (bool enabled, List<String> items) => _checkboxOnChanged(context, enabled, items) : null,
        );
      },
    );
  }
