...
final class MyoroRadioWidgetShowcaseThemeExtension extends ThemeExtension<MyoroRadioWidgetShowcaseThemeExtension> {
  ...
  const MyoroRadioWidgetShowcaseThemeExtension.builder() : inputStyle = MyoroInputStyleEnum.outlined;
  ...
  @override
  MyoroRadioWidgetShowcaseThemeExtension lerp(covariant ThemeExtension<MyoroRadioWidgetShowcaseThemeExtension>? other, double t) {
  ...
  bool operator ==(Object other) {
    return other is MyoroRadioWidgetShowcaseThemeExtension && other.runtimeType == runtimeType && other.inputStyle == inputStyle;
  }
