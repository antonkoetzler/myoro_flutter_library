...
final class MyoroPieGraphWidgetShowcaseThemeExtension extends ThemeExtension<MyoroPieGraphWidgetShowcaseThemeExtension> {
  ...
  const MyoroPieGraphWidgetShowcaseThemeExtension({required this.centerWidgetBorderRadius, required this.centerWidgetSize});
  ...
  MyoroPieGraphWidgetShowcaseThemeExtension.builder() : centerWidgetBorderRadius = BorderRadius.circular(kMyoroBorderRadiusLength), centerWidgetSize = 125;

  @override
  MyoroPieGraphWidgetShowcaseThemeExtension copyWith({BorderRadius? centerWidgetBorderRadius, double? centerWidgetSize}) {
  ...
  @override
  MyoroPieGraphWidgetShowcaseThemeExtension lerp(covariant ThemeExtension<MyoroPieGraphWidgetShowcaseThemeExtension>? other, double t) {
