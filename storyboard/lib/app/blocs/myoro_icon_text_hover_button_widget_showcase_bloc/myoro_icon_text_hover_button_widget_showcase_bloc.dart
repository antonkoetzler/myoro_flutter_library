  ...
  void _setIconSizeEvent(SetIconSizeEvent event, _Emitter emit) {
    emit(
      state.copyWith(
        ...
        iconSizeEnabled: event.iconSize != null,
      ),
    );
  }
  ...
  void _setTextStyleEvent(SetTextStyleEvent event, _Emitter emit) {
    emit(
      state.copyWith(
        ...
        textStyleEnabled: event.textStyle != null,
      ),
    );
  }
  ...
  void _setTextAlignEvent(SetTextAlignEvent event, _Emitter emit) {
    emit(
      state.copyWith(
        ...
        textAlignEnabled: event.textAlign != null,
      ),
    );
  }
  ...
  void _setPaddingEvent(SetPaddingEvent event, _Emitter emit) {
    emit(
      state.copyWith(
        ...
        paddingEnabled: event.padding != null,
      ),
    );
  }
  ...
  void _setMainAxisAlignmentEvent(
    ...
    emit(
      state.copyWith(
        ...
        mainAxisAlignmentEnabled: event.mainAxisAlignment != null,
      ),
    );
  }
