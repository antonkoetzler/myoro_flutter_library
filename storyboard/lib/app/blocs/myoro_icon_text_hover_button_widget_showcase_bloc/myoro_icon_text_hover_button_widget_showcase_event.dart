...
final class SetIconSizeEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
...
final class SetTextStyleEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
  final TextStyle? textStyle;

  const SetTextStyleEvent([this.textStyle]);
}

final class SetTextAlignEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
  final TextAlign? textAlign;

  const SetTextAlignEvent([this.textAlign]);
}

final class SetPaddingEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
  final double? padding;

  const SetPaddingEvent([this.padding]);
}

final class SetMainAxisAlignmentEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
  final MainAxisAlignment? mainAxisAlignment;

  const SetMainAxisAlignmentEvent([this.mainAxisAlignment]);
}

final class SetOnPressedEnabledEvent extends MyoroIconTextHoverButtonWidgetShowcaseEvent {
