...
import 'package:storyboard/modules/widget_showcase/blocs/myoro_drawer_widget_showcase_bloc/myoro_drawer_widget_showcase_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const WidgetShowcase(
        widgetName: StoryboardWidgetListingEnum.myoroDrawerTitle,
        widget: _Widget(),
        widgetOptions: [
          _TitleOption(),
