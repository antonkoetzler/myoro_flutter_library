...
import 'package:storyboard/modules/widget_showcase/blocs/myoro_tooltip_widget_showcase_bloc/myoro_tooltip_widget_showcase_bloc.dart';
...
final class MyoroTooltipWidgetShowcase extends StatelessWidget {
  ...
  List<Widget> _widgetOptionsBuilder() {
    return const [_MarginOption(), _TextOption()];
  }
}
...
final class _Child extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final themeExtension =
        context.resolveThemeExtension<MyoroTooltipWidgetShowcaseThemeExtension>();
  ...
  Widget build(BuildContext context) {
    return MyoroInput(
      configuration: MyoroInputConfiguration(
        ...
        inputStyle:
            context.resolveThemeExtension<MyoroTooltipWidgetShowcaseThemeExtension>().inputStyle,
        onChanged:
            (String text) =>
                context.resolveBloc<MyoroTooltipWidgetShowcaseBloc>().add(SetTextEvent(text)),
      ),
    );
  }
}
