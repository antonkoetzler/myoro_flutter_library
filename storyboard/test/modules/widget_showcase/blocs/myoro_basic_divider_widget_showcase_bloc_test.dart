...
void main() {
  ...
  blocTest(
    ...
    expect:
        () => [MyoroBasicDividerWidgetShowcaseState(shortValue: shortValue, direction: direction)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroBasicDividerWidgetShowcaseState(shortValue: newShortValue)],
  );
  ...
  blocTest(
    ...
    expect:
        () => [
          MyoroBasicDividerWidgetShowcaseState(shortValue: shortValue, verticalPadding: padding),
          MyoroBasicDividerWidgetShowcaseState(shortValue: shortValue, horizontalPadding: padding),
        ],
  );
}
