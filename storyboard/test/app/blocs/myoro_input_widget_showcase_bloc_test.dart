...
void main() {
  ...
  setUpAll(() {
    ...
    inputTextStyle = faker.randomGenerator.boolean() ? MyoroTypographyDesignSystem.instance.randomTextStyle : null;
  ...
  blocTest('MyoroInputWidgetShowcaseBloc.SetCheckboxOnChangedEnabledEvent', build: () => MyoroInputWidgetShowcaseBloc());
}
