...
void main() {
  final IconData? icon = faker.randomGenerator.boolean() ? kMyoroTestIcons[faker.randomGenerator.integer(kMyoroTestIcons.length)] : null;
  final double? iconSize = faker.randomGenerator.boolean() ? faker.randomGenerator.decimal() : null;
  final String text = faker.randomGenerator.string(1000, min: 0);
  late final TextStyle? textStyle;
  final TextAlign? textAlign = faker.randomGenerator.boolean() ? TextAlign.values[faker.randomGenerator.integer(TextAlign.values.length)] : null;
  final double? padding = faker.randomGenerator.boolean() ? faker.randomGenerator.decimal() : null;
  final MainAxisAlignment? mainAxisAlignment =
      faker.randomGenerator.boolean() ? MainAxisAlignment.values[faker.randomGenerator.integer(MainAxisAlignment.values.length)] : null;
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(iconSize: iconSize)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(textStyle: textStyle)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(textAlign: textAlign)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(padding: padding)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(mainAxisAlignment: mainAxisAlignment)],
  );
  ...
  blocTest(
    ...
    expect: () => [MyoroIconTextHoverButtonWidgetShowcaseState(onPressedEnabled: onPressedEnabled)],
  );
}
