...
void main() {
  ...
  test('MyoroAppBarWidgetShowcaseThemeExtension.copyWith', () {
    ...
    expect(copiedThemeExtension.mockAppLogoIcon, themeExtension2.mockAppLogoIcon);
    expect(copiedThemeExtension.mockAppTitleTextStyle, themeExtension2.mockAppTitleTextStyle);
    expect(copiedThemeExtension.logoTitleSpacing, themeExtension2.logoTitleSpacing);
    expect(copiedThemeExtension.mockAppLogoIcon, themeExtension2.mockAppLogoIcon);
  });
  ...
  test('MyoroAppBarWidgetShowcaseThemeExtension.lerp', () {
    for (double i = 0; i < faker.randomGenerator.decimal(); i += 0.1) {
      ...
      expect(
        ...
        TextStyle.lerp(themeExtension1.mockAppTitleTextStyle, themeExtension2.mockAppTitleTextStyle, i),
      );
      expect(
