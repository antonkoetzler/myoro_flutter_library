...
void main() {
  ...
  test('MyoroInputWidgetShowcaseThemeExtension.copyWith', () {
    ...
    expect(copiedThemeExtension.configurationOptionTextStyle, themeExtension2.configurationOptionTextStyle);
    expect(copiedThemeExtension.configurationOptionSpacing, themeExtension2.configurationOptionSpacing);
    expect(copiedThemeExtension.inputStyle, themeExtension2.inputStyle);
    expect(copiedThemeExtension.suffixWidgetIcon, themeExtension2.suffixWidgetIcon);
  });
  ...
  test('MyoroInputWidgetShowcaseThemeExtension.lerp', () {
    for (double i = 0; i < faker.randomGenerator.decimal(); i += 0.1) {
      ...
      expect(
        ...
        TextStyle.lerp(themeExtension1.configurationOptionTextStyle, themeExtension2.configurationOptionTextStyle, i),
      );
      expect(
        lerpedThemeExtension.configurationOptionSpacing,
        lerpDouble(themeExtension1.configurationOptionSpacing, themeExtension2.configurationOptionSpacing, i),
      );
      expect(
