...
T myoroFake<T>() {
  if (T is Alignment) {
    return kMyoroTestAlignments[faker.randomGenerator.integer(
          kMyoroTestAlignments.length,
        )]
        as T;
  }
  ...
  if (T is BorderStyle) {
    return BorderStyle.values[faker.randomGenerator.integer(
  ...
  if (T is Color) {
    return kMyoroTestColors[faker.randomGenerator.integer(
          kMyoroTestColors.length,
        )]
        as T;
  }
  ...
  if (T is Curves) {
    return kMyoroTestCurves[faker.randomGenerator.integer(
          kMyoroTestCurves.length,
        )]
        as T;
  }

  if (T is DismissDirection) {
    return DismissDirection.values[faker.randomGenerator.integer(
  ...
  if (T is FloatingLabelBehavior) {
    return FloatingLabelBehavior.values[faker.randomGenerator.integer(
  ...
  if (T is IconData) {
    return kMyoroTestIcons[faker.randomGenerator.integer(
  ...
  if (T is OutlineInputBorder) {
    return OutlineInputBorder(
          ...
          borderSide: myoroFake<BorderSide>(),
        )
        as T;
  }
  ...
  if (T is SnackBarBehavior) {
    return SnackBarBehavior.values[faker.randomGenerator.integer(
  ...
  if (T is SystemMouseCursors) {
    return kMyoroTestCursors[faker.randomGenerator.integer(
  ...
  if (T is TextAlign) {
    return TextAlign.values[faker.randomGenerator.integer(
  ...
  if (T is TextOverflow) {
    return TextOverflow.values[faker.randomGenerator.integer(
  ...
  if (T is ThemeMode) {
    return ThemeMode.values[faker.randomGenerator.integer(
