...
abstract class AppLocalizations {
  ...
  /// No description provided for @myoroDialogModalCancelButtonText.
  ///
  /// In en, this message translates to:
  /// **'Cancel'**
  String get myoroDialogModalCancelButtonText;

  /// No description provided for @myoroDialogModalConfirmButtonText.
  ///
  /// In en, this message translates to:
  /// **'Confirm'**
  ...
  /// No description provided for @myoroListScrollableEmptyFeedbackTitle.
  ///
  /// In en, this message translates to:
  /// **'No items.'**
  String get myoroListScrollableEmptyFeedbackTitle;
}
