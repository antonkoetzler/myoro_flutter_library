...
part 'myoro_list_scrollable_configuration.g.dart';

/// Configuration for [MyoroListScrollable].
@immutable
@myoroModel
class MyoroListScrollableConfiguration with _$MyoroListScrollableConfigurationMixin, MyoroScrollableConfigurationMixin {
  /// Creates a new instance of [MyoroListScrollableConfiguration].
  const MyoroListScrollableConfiguration({
  ...
  /// Creates a fake instance of [MyoroListScrollableConfiguration] for testing purposes.
  MyoroListScrollableConfiguration.fake()
