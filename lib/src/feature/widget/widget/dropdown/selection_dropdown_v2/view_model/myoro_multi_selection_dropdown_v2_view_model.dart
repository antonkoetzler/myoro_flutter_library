...
/// View model of [MyoroMultiSelectionDropdownV2].
class MyoroMultiSelectionDropdownV2ViewModel<T>
    extends
        ...
        > {
  MyoroMultiSelectionDropdownV2ViewModel(MyoroMultiSelectionDropdownV2Configuration<T> configuration)
    : super(
        configuration,
