...
part 'myoro_primary_button_style_theme_extension.g.dart';

/// [MyoroButton]'s  variant's [ThemeExtension].
@immutable
@myoroThemeExtension
final class MyoroPrimaryButtonStyleThemeExtension
    extends MyoroButtonStyleThemeExtension<MyoroPrimaryButtonStyleThemeExtension>
    with _$MyoroPrimaryButtonStyleThemeExtensionMixin {
  const MyoroPrimaryButtonStyleThemeExtension({
  ...
  factory MyoroPrimaryButtonStyleThemeExtension.fake() {
  ...
  factory MyoroPrimaryButtonStyleThemeExtension.builder(bool isDarkMode, ColorScheme colorScheme) {
    const hoverBackgroundColorFactor = 0.15;
    const tapBackgroundColorFactor = 0.2;

    final primary = colorScheme.primary;
    final onPrimary = colorScheme.onPrimary;

    return MyoroPrimaryButtonStyleThemeExtension(
      idleBackgroundColor: onPrimary,
      ...
      idleContentColor: primary,
      hoverContentColor: primary,
      tapContentColor: primary,
    );
  }

  @override
  MyoroPrimaryButtonStyleThemeExtension lerp(
    covariant ThemeExtension<MyoroPrimaryButtonStyleThemeExtension>? other,
    double t,
  ) {
