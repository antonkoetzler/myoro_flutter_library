...
final class MyoroImagePickerViewModel {
  MyoroImagePickerViewModel(String label, String? selectedImage, MyoroImagePickerOnChanged onChanged)
    : _state = MyoroImagePickerState(label, selectedImage, onChanged) {
