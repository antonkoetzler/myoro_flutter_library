...
class MyoroGroupCheckboxController extends ValueNotifier<MyoroGroupCheckboxItems> {
  MyoroGroupCheckboxController({required MyoroGroupCheckboxItems checkboxes})
    : assert(checkboxes.isNotEmpty, '[MyoroGroupCheckboxController]: [checkboxes] cannot be empty.'),
      super(checkboxes);
