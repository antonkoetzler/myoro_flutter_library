...
final class _Columns<T> extends StatelessWidget {
  ...
  Widget build(context) {
    ...
    final basicDividerThemeExtension = context
        .resolveThemeExtension<MyoroBasicDividerThemeExtension>();

    final decorationBorderRadius =
        tableThemeExtension.decoration?.borderRadius as BorderRadius? ?? BorderRadius.zero;
      ...
      builder: (_, _) {
        return ClipRRect(
          ...
          child: Row(
            ...
            spacing:
                (tableThemeExtension.columnSpacing ?? 0 / 2) -
                ((basicDividerThemeExtension.shortValue ?? 0) / 2),
