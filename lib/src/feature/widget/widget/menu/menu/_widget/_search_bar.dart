...
final class _SearchBar<T> extends StatelessWidget {
  ...
  Widget build(context) {
    ...
    final searchBarInputStyle = style.searchBarInputStyle ?? themeExtension.searchBarInputStyle ?? MyoroInput.inputStyleDefaultValue;
    ...
    return Padding(
      ...
      child: MyoroInput(inputStyle: searchBarInputStyle, autofocus: true, onChanged: search),
    );
  }
}
