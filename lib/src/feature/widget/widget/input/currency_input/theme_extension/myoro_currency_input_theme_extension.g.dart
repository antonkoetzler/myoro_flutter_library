...
part of 'myoro_currency_input_theme_extension.dart';
...
/// Apply this mixin to [MyoroCurrencyInputThemeExtension] once the code is generated.
///
/// ```dart
/// class MyoroCurrencyInputThemeExtension with _$MyoroCurrencyInputThemeExtensionMixin {}
/// ```
mixin _$MyoroCurrencyInputThemeExtensionMixin on ThemeExtension<MyoroCurrencyInputThemeExtension> {
  MyoroCurrencyInputThemeExtension get self => this as MyoroCurrencyInputThemeExtension;

  @override
  MyoroCurrencyInputThemeExtension copyWith({
    InputBorder? border,
    ...
    bool currencyPrefixPaddingProvided = true,
  }) {
    return MyoroCurrencyInputThemeExtension(
      ...
      currencySymbolButtonStyle: currencySymbolButtonStyleProvided
          ...
          : null,
      currencyPrefixPadding: currencyPrefixPaddingProvided
  ...
  bool operator ==(Object other) {
    return other is MyoroCurrencyInputThemeExtension &&
