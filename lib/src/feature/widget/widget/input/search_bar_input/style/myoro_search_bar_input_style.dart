...
part 'myoro_search_bar_input_style.g.dart';

/// Style model of [MyoroSearchBarInput].
@immutable
@myoroModel
class MyoroSearchBarInputStyle extends MyoroInputStyle with _$MyoroSearchBarInputStyleMixin {
  /// Lerp function.
  static MyoroSearchBarInputStyle lerp(MyoroSearchBarInputStyle? a, MyoroSearchBarInputStyle? b, double t) {
  ...
  /// Default constructor.
  const MyoroSearchBarInputStyle({
    super.border,
  ...
  /// Fake constructor.
  factory MyoroSearchBarInputStyle.fake() {
    return MyoroSearchBarInputStyle(
