...
part of 'myoro_search_bar_input_theme_extension.dart';
...
/// Apply this mixin to [MyoroSearchBarInputThemeExtension] once the code is generated.
///
/// ```dart
/// class MyoroSearchBarInputThemeExtension with _$MyoroSearchBarInputThemeExtensionMixin {}
/// ```
mixin _$MyoroSearchBarInputThemeExtensionMixin on ThemeExtension<MyoroSearchBarInputThemeExtension> {
  MyoroSearchBarInputThemeExtension get self => this as MyoroSearchBarInputThemeExtension;

  @override
  MyoroSearchBarInputThemeExtension copyWith({
    InputBorder? border,
  ...
  bool operator ==(Object other) {
    return other is MyoroSearchBarInputThemeExtension &&
