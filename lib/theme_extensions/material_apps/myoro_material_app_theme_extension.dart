...
final class MyoroMaterialAppThemeExtension extends ThemeExtension<MyoroMaterialAppThemeExtension> {
  ...
  @override
  ThemeExtension<MyoroMaterialAppThemeExtension> lerp(covariant ThemeExtension<MyoroMaterialAppThemeExtension>? other, double t) {
    return this;
  }

  @override
  bool operator ==(Object other) {
    return other is MyoroMaterialAppThemeExtension && other.runtimeType == runtimeType;
  }
