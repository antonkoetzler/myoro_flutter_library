...
final class MyoroAppBarThemeExtension extends ThemeExtension<MyoroAppBarThemeExtension> {
  ...
  MyoroAppBarThemeExtension.builder(ColorScheme colorScheme) : primaryColor = colorScheme.primary, contentPadding = const EdgeInsets.all(10);

  @override
  MyoroAppBarThemeExtension copyWith({Color? primaryColor, EdgeInsets? contentPadding}) {
    return MyoroAppBarThemeExtension(primaryColor: primaryColor ?? this.primaryColor, contentPadding: contentPadding ?? this.contentPadding);
  }
  ...
  MyoroAppBarThemeExtension lerp(covariant ThemeExtension<MyoroAppBarThemeExtension>? other, double t) {
    ...
    return copyWith(primaryColor: Color.lerp(primaryColor, other.primaryColor, t), contentPadding: EdgeInsets.lerp(contentPadding, other.contentPadding, t));
  }
