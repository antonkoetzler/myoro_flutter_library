...
final class MyoroPieGraphThemeExtension extends ThemeExtension<MyoroPieGraphThemeExtension> {
  ...
  MyoroPieGraphThemeExtension copyWith({Color? itemColor, double? itemRadius}) {
    return MyoroPieGraphThemeExtension(itemColor: itemColor ?? this.itemColor, itemRadius: itemRadius ?? this.itemRadius);
  }
  ...
  MyoroPieGraphThemeExtension lerp(covariant ThemeExtension<MyoroPieGraphThemeExtension>? other, double t) {
    ...
    return copyWith(itemColor: Color.lerp(itemColor, other.itemColor, t), itemRadius: lerpDouble(itemRadius, other.itemRadius, t));
  }

  @override
  bool operator ==(Object other) {
    return other is MyoroPieGraphThemeExtension && other.runtimeType == runtimeType && other.itemColor == itemColor && other.itemRadius == itemRadius;
  }
