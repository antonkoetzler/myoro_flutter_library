...
final class MyoroTooltipThemeExtension extends ThemeExtension<MyoroTooltipThemeExtension> {
  ...
  const MyoroTooltipThemeExtension.builder() : waitDuration = kMyoroTooltipWaitDuration, margin = EdgeInsets.zero;

  @override
  MyoroTooltipThemeExtension copyWith({Duration? waitDuration, EdgeInsets? margin}) {
    return MyoroTooltipThemeExtension(waitDuration: waitDuration ?? this.waitDuration, margin: margin ?? this.margin);
  }
  ...
  MyoroTooltipThemeExtension lerp(covariant ThemeExtension<MyoroTooltipThemeExtension>? other, double t) {
    ...
    return copyWith(waitDuration: myoroLerp(waitDuration, other.waitDuration, t), margin: EdgeInsets.lerp(margin, other.margin, t));
  }

  @override
  bool operator ==(Object other) {
    return other is MyoroTooltipThemeExtension && other.runtimeType == runtimeType && other.waitDuration == waitDuration && other.margin == margin;
  }
