...
class MyoroIconTextButtonThemeExtension extends ThemeExtension<MyoroIconTextButtonThemeExtension> {
  ...
  MyoroIconTextButtonThemeExtension.fake() : textStyle = MyoroTypographyDesignSystem.instance.randomTextStyle;

  MyoroIconTextButtonThemeExtension.builder(TextTheme textTheme) : textStyle = textTheme.bodyMedium!;
