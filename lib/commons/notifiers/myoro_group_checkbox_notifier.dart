...
final class MyoroGroupCheckboxNotifier extends ValueNotifier<MyoroGroupCheckboxItems> {
  ...
  void changeAll([bool enabled = false]) {
    value = {
      for (final MapEntry<String, bool> entry in value.entries) entry.key: enabled,
    };
  }
