...
void main() {
  ...
  test('MyoroDrawerThemeExtension.copyWith', () {
    ...
    expect(copiedThemeExtension.drawerContentPadding, themeExtension2.drawerContentPadding);
    expect(copiedThemeExtension.drawerShape, themeExtension2.drawerShape);
    expect(copiedThemeExtension.titleContentDividerPadding, themeExtension2.titleContentDividerPadding);
    expect(copiedThemeExtension.titleTextStyle, themeExtension2.titleTextStyle);
    expect(copiedThemeExtension.closeButtonDrawerIcon, themeExtension2.closeButtonDrawerIcon);
    expect(copiedThemeExtension.closeButtonEndDrawerIcon, themeExtension2.closeButtonEndDrawerIcon);
    expect(copiedThemeExtension.closeButtonBackgroundColor, themeExtension2.closeButtonBackgroundColor);
    expect(copiedThemeExtension.closeButtonBordered, themeExtension2.closeButtonBordered);
  });
  ...
  test('MyoroDrawerThemeExtension.lerp', () {
    for (double i = 0; i < faker.randomGenerator.decimal(); i += 0.1) {
      ...
      expect(
        ...
        Color.lerp(themeExtension1.closeButtonBackgroundColor, themeExtension2.closeButtonBackgroundColor, i),
      );
      expect(
        lerpedThemeExtension.closeButtonBordered,
        myoroLerp(themeExtension1.closeButtonBordered, themeExtension2.closeButtonBordered, i),
      );
    }
  });
}
