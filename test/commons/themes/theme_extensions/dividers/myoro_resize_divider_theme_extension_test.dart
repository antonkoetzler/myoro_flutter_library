...
void main() {
  ...
  test('MyoroResizeDividerThemeExtension.copyWith', () {
    ...
    expect(copiedThemeExtension.resizeButtonShortValue, themeExtension2.resizeButtonShortValue);
    expect(copiedThemeExtension.resizeButtonLongValue, themeExtension2.resizeButtonLongValue);
    expect(copiedThemeExtension.resizeButtonBorderRadius, themeExtension2.resizeButtonBorderRadius);
  });
