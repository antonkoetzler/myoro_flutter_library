...
void main() {
  ...
  test('createAppBarThemeExtensions', () => expect(createMyoroAppBarThemeExtensions(colorScheme).length, 1));
  test('createMyoroButtonThemeExtensions', () => expect(createMyoroButtonThemeExtensions(colorScheme, textTheme).length, 2));
  test('createMyoroCardThemeExtensions', () => expect(createMyoroCardThemeExtensions(colorScheme, textTheme).length, 1));
  test('createMyoroCarouselThemeExtensions', () => expect(createMyoroCarouselThemeExtensions().length, 1));
  test('createMyoroCheckboxThemeExtensions', () => expect(createMyoroCheckboxThemeExtensions(colorScheme, textTheme).length, 2));
  test('createMyoroDividerThemeExtensions', () => expect(createMyoroDividerThemeExtensions(colorScheme).length, 2));
  test('createMyoroDropdownThemeExtensions', () => expect(createMyoroDropdownThemeExtensions(textTheme).length, 1));
  test('createMyoroDrawerThemeExtension', () => expect(createMyoroDrawerThemeExtension(colorScheme, textTheme).length, 1));
  test('createMyoroFormThemeExtensions', () => expect(createMyoroFormThemeExtensions().length, 1));
  test('createMyoroGraphThemeExtensions', () => expect(createMyoroGraphThemeExtensions(colorScheme, textTheme).length, 2));
  test('createMyoroInputThemeExtensions', () => expect(createMyoroInputThemeExtensions(colorScheme, textTheme).length, 3));
  test('createMyoroLayoutBuilderThemeExtensions', () => expect(createMyoroLayoutBuilderThemeExtensions().length, 1));
  test('createMyoroLoaderThemeExtensions', () => expect(createMyoroLoaderThemeExtensions(colorScheme).length, 1));
  test('createMyoroMaterialAppThemeExtensions', () => expect(createMyoroMaterialAppThemeExtensions().length, 1));
  test('createMyoroMenuThemeExtensions', () => expect(createMyoroMenuThemeExtensions(colorScheme, textTheme).length, 1));
  test('createMyoroModalThemeExtensions', () => expect(createMyoroModalThemeExtensions(colorScheme, textTheme).length, 2));
  ...
  test('createMyoroTooltipThemeExtensions', () => expect(createMyoroTooltipThemeExtensions().length, 1));
}
