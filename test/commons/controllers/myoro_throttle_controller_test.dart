...
void main() {
  ...
  test('MyoroThrottleController.run', () async {
    ...
    await Future.delayed(Duration(milliseconds: duration.inMilliseconds + 2)); // Not too sure why we need to wait an extra 2 milliseconds...
    throttler.run(incrementValue);
    expect(value, 2); // After waiting for the [throttler]'s duration, the callback will execute again.
  });
}
