  ...
  test('MyoroMultiDropdownConfiguration.setInitiallySelectedItems', () {
    ...
    if (configuration.initiallySelectedItems.isNotEmpty) {
      expectLater(
        ...
        emitsInOrder([MyoroDropdownState<String>(enabled: enabled, selectedItems: configuration.initiallySelectedItems)]),
      );
    }
  });
...
MyoroMultiDropdownConfiguration<String> _createConfiguration() {
  ...
  final Set<String> items = List.generate(faker.randomGenerator.integer(50), (int index) => '#$index ${faker.randomGenerator.string(50)}').toSet();
  ...
  return MyoroMultiDropdownConfiguration<String>(
    ...
    initiallySelectedItems:
        faker.randomGenerator.boolean() ? List.generate(faker.randomGenerator.integer(items.length), (int index) => items.elementAt(index)).toSet() : null,
