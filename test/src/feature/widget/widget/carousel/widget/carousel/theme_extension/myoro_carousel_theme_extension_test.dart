  ...
  test('MyoroCarouselThemeExtension.lerp', () {
    ...
    for (double i = 0; i < 1; i += 0.1) {
      ...
      expect(
        ...
        myoroFallbackLerp(themeExtension1.previousItemButtonIcon, themeExtension2.previousItemButtonIcon, i),
      );
      expect(
        lerpedThemeExtension.nextItemButtonIcon,
        myoroFallbackLerp(themeExtension1.nextItemButtonIcon, themeExtension2.nextItemButtonIcon, i),
      );
    }
  });
}
