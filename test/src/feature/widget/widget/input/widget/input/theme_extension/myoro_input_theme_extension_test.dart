  ...
  test('MyoroInputThemeExtension.lerp', () {
    ...
    for (double i = 0; i < 1; i += 0.1) {
      ...
      expect(
        ...
        myoroFallbackLerp(themeExtension1.underlinedBorder, themeExtension2.underlinedBorder, i),
      );
      expect(
        lerpedThemeExtension.outlinedBorder,
        myoroFallbackLerp(themeExtension1.outlinedBorder, themeExtension2.outlinedBorder, i),
      );
      expect(
        lerpedThemeExtension.noneBorder,
        myoroFallbackLerp(themeExtension1.noneBorder, themeExtension2.noneBorder, i),
      );
      expect(
      ...
      expect(
        ...
        myoroFallbackLerp(themeExtension1.labelBehavior, themeExtension2.labelBehavior, i),
      );
      expect(
      ...
      expect(
        ...
        myoroFallbackLerp(themeExtension1.clearTextButtonIcon, themeExtension2.clearTextButtonIcon, i),
      );
    }
  });
}
