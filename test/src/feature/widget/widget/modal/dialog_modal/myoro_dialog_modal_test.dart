...
void main() {
  ...
  testWidgets('MyoroDialogModal confirm button functionality', (tester) async {
    ...
    await testCase(
      tester,
      (configuration) =>
          configuration.copyWith(confirmButtonText: confirmButtonText, onConfirm: () => onConfirmExecuted = true),
      () async {
  ...
  testWidgets('MyoroDialogModal cancel button functionality', (tester) async {
    ...
    await testCase(
      tester,
      (configuration) =>
          configuration.copyWith(cancelButtonText: cancelButtonText, onCancel: () => onCancelExecuted = true),
      () async {
  ...
  testWidgets('MyoroDialogModal with MyoroDialogModalConfiguration.child provided', (tester) async {
    ...
    await testCase(
      tester,
      (configuration) => configuration.copyWith(text: kMyoroEmptyString, child: child),
