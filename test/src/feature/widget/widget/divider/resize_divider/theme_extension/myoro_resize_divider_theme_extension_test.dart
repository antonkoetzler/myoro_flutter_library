...
void main() {
  test('MyoroResizeDividerThemeExtension.builder', () {
    ...
    final themeExtension = MyoroResizeDividerThemeExtension.builder(basicDividerThemeExtension, colorScheme);
    expect(themeExtension.resizeButtonColor, colorScheme.onPrimary);
    expect(themeExtension.resizeButtonShortValue, kMyoroBorderWidth);
    expect(themeExtension.resizeButtonLongValue, kMyoroBorderWidth);
    expect(themeExtension.resizeButtonBorderRadius, BorderRadius.circular(kMyoroBorderRadius));
  });
  ...
  test('MyoroResizeDividerThemeExtension.lerp', () {
    ...
    for (double i = 0; i < 1; i += 0.1) {
      ...
      expect(
        lerpedThemeExtension.resizeButtonColor,
        Color.lerp(themeExtension1.resizeButtonColor, themeExtension2.resizeButtonColor, i),
      );
      expect(
