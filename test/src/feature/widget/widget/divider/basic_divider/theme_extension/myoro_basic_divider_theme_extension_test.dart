...
void main() {
  test('MyoroBasicDividerThemeExtension.builder', () {
    ...
    expect(themeExtension.shortValue, kMyoroBorderWidth);
    expect(themeExtension.longValue, double.infinity);
  });

  test('MyoroBasicDividerThemeExtension.fromResizeDividerThemeExtension', () {
    final resizeDividerThemeExtension = MyoroResizeDividerThemeExtension.fake();
    final basicDividerThemeExtension = MyoroBasicDividerThemeExtension.fromResizeDividerThemeExtension(
      resizeDividerThemeExtension,
    );

    expect(basicDividerThemeExtension.color, resizeDividerThemeExtension.color);
    expect(basicDividerThemeExtension.shortValue, resizeDividerThemeExtension.shortValue);
    expect(basicDividerThemeExtension.longValue, resizeDividerThemeExtension.longValue);
  });
