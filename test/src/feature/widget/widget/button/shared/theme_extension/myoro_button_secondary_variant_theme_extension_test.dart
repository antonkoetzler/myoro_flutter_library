...
void main() {
  test('MyoroButtonSecondaryVariantThemeExtension.builder', () {
    final isDarkMode = faker.randomGenerator.boolean();
    final colorScheme = createMyoroColorScheme(isDarkMode);
    final themeExtension = MyoroButtonSecondaryVariantThemeExtension.builder(isDarkMode, colorScheme);
    ...
    expect(
      ...
      isDarkMode
          ? onPrimary.darken(MyoroButtonSecondaryVariantThemeExtension.secondaryBackgroundHoverColorFactor)
          : onPrimary.brighten(MyoroButtonSecondaryVariantThemeExtension.secondaryBackgroundHoverColorFactor),
    );
    expect(
      themeExtension.backgroundTapColor,
      isDarkMode
          ? onPrimary.darken(MyoroButtonSecondaryVariantThemeExtension.secondaryBackgroundTapColorFactor)
          : onPrimary.brighten(MyoroButtonSecondaryVariantThemeExtension.secondaryBackgroundTapColorFactor),
    );
    ...
    expect(themeExtension.borderColor, onPrimary);
  });

  test('MyoroButtonSecondaryVariantThemeExtension.lerp', () {
    final themeExtension1 = MyoroButtonSecondaryVariantThemeExtension.fake();
    final themeExtension2 = MyoroButtonSecondaryVariantThemeExtension.fake();
