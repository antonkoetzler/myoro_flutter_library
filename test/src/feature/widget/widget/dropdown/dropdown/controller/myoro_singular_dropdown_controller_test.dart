...
void main() {
  Future<void> testCase(WidgetTester tester, FutureOr<void> Function(MyoroSingularDropdownController<String> controller) callback) async {
    ...
    configuration: MyoroSingularDropdownConfiguration(
      menuConfiguration: MyoroSingularMenuConfiguration(
        ...
        itemBuilder: (v) => MyoroMenuItem(
          iconTextButtonConfiguration: MyoroIconTextButtonConfiguration(textConfiguration: MyoroTextConfiguration(text: v)),
        ),
      ),
