...
void main() {
  test('MyoroDropdownsThemeExtension.builder', () {
    final colorScheme = createMyoroColorScheme(faker.randomGenerator.boolean());
    final themeExtension = MyoroDropdownsThemeExtension.builder(colorScheme);
  ...
  test('MyoroDropdownsThemeExtension.lerp', () {
    final themeExtension1 = MyoroDropdownsThemeExtension.fake();
    final themeExtension2 = MyoroDropdownsThemeExtension.fake();
