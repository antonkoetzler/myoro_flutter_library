...
void main() {
  test('MyoroSelectionDropdownThemeExtension.builder', () {
    final colorScheme = createMyoroColorScheme(faker.randomGenerator.boolean());
    final themeExtension = MyoroSelectionDropdownThemeExtension.builder(colorScheme);
  ...
  test('MyoroSelectionDropdownThemeExtension.lerp', () {
    final themeExtension1 = MyoroSelectionDropdownThemeExtension.fake();
    final themeExtension2 = MyoroSelectionDropdownThemeExtension.fake();
