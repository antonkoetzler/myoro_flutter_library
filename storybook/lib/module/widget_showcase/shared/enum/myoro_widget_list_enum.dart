...
enum MyoroWidgetListEnum {
  ...
  dropdowns('Dropdowns', {myoroDropdownsTitle, myoroInputDropdownTitle, myoroSelectionDropdownsTitle}),
  ...
  static const myoroInputDropdownTitle = 'MyoroSingleInputDropdown & MyoroMultiInputDropdown';
