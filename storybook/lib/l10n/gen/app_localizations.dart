...
abstract class AppLocalizations {
  ...
  /// No description provided for @storybookWidgetListEnumRequestsCategoryName.
  ///
  /// In en, this message translates to:
  /// **'Requests'**
  String get storybookWidgetListEnumRequestsCategoryName;
  ...
  /// No description provided for @storybookWidgetShowcaseOptionScrollablePaddingLabel.
  ///
  /// In en, this message translates to:
  /// **'Padding'**
  String get storybookWidgetShowcaseOptionScrollablePaddingLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableSpacingLabel.
  ///
  /// In en, this message translates to:
  /// **'Spacing'**
  String get storybookWidgetShowcaseOptionScrollableSpacingLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableDirectionLabel.
  ///
  /// In en, this message translates to:
  /// **'Direction'**
  String get storybookWidgetShowcaseOptionScrollableDirectionLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableReverseLabel.
  ///
  /// In en, this message translates to:
  /// **'Reverse'**
  String get storybookWidgetShowcaseOptionScrollableReverseLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableClipBehaviorLabel.
  ///
  /// In en, this message translates to:
  /// **'Clip behavior'**
  String get storybookWidgetShowcaseOptionScrollableClipBehaviorLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableClipBehaviorNoneLabel.
  ///
  /// In en, this message translates to:
  /// **'None'**
  String get storybookWidgetShowcaseOptionScrollableClipBehaviorNoneLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableClipBehaviorHardEdgeLabel.
  ///
  /// In en, this message translates to:
  /// **'Hard edge'**
  String get storybookWidgetShowcaseOptionScrollableClipBehaviorHardEdgeLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableClipBehaviorAntiAliasLabel.
  ///
  /// In en, this message translates to:
  /// **'Anti alias'**
  String get storybookWidgetShowcaseOptionScrollableClipBehaviorAntiAliasLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableClipBehaviorAntiAliasWithSaveLayerLabel.
  ///
  /// In en, this message translates to:
  /// **'Anti alias with save layer'**
  String get storybookWidgetShowcaseOptionScrollableClipBehaviorAntiAliasWithSaveLayerLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableDragStartBehaviorLabel.
  ///
  /// In en, this message translates to:
  /// **'Drag start behavior'**
  String get storybookWidgetShowcaseOptionScrollableDragStartBehaviorLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableDragStartBehaviorDownLabel.
  ///
  /// In en, this message translates to:
  /// **'Down'**
  String get storybookWidgetShowcaseOptionScrollableDragStartBehaviorDownLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableDragStartBehaviorStartLabel.
  ///
  /// In en, this message translates to:
  /// **'Start'**
  String get storybookWidgetShowcaseOptionScrollableDragStartBehaviorStartLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsLabel.
  ///
  /// In en, this message translates to:
  /// **'Physics'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsNoneLabel.
  ///
  /// In en, this message translates to:
  /// **'None'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsNoneLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsAlwaysScrollableLabel.
  ///
  /// In en, this message translates to:
  /// **'Always scrollable'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsAlwaysScrollableLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsNeverScrollableLabel.
  ///
  /// In en, this message translates to:
  /// **'Never scrollable'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsNeverScrollableLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsBouncingLabel.
  ///
  /// In en, this message translates to:
  /// **'Bouncing'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsBouncingLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsClampingLabel.
  ///
  /// In en, this message translates to:
  /// **'Clamping'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsClampingLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePhysicsCustomLabel.
  ///
  /// In en, this message translates to:
  /// **'Custom'**
  String get storybookWidgetShowcaseOptionScrollablePhysicsCustomLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableItemCountLabel.
  ///
  /// In en, this message translates to:
  /// **'Item count'**
  String get storybookWidgetShowcaseOptionScrollableItemCountLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollablePrimaryLabel.
  ///
  /// In en, this message translates to:
  /// **'Primary'**
  String get storybookWidgetShowcaseOptionScrollablePrimaryLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableShrinkWrapLabel.
  ///
  /// In en, this message translates to:
  /// **'Shrink wrap'**
  String get storybookWidgetShowcaseOptionScrollableShrinkWrapLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableAddAutomaticKeepAlivesLabel.
  ///
  /// In en, this message translates to:
  /// **'Add automatic keep alives'**
  String get storybookWidgetShowcaseOptionScrollableAddAutomaticKeepAlivesLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableAddRepaintBoundariesLabel.
  ///
  /// In en, this message translates to:
  /// **'Add repaint boundaries'**
  String get storybookWidgetShowcaseOptionScrollableAddRepaintBoundariesLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableAddSemanticIndexesLabel.
  ///
  /// In en, this message translates to:
  /// **'Add semantic indexes'**
  String get storybookWidgetShowcaseOptionScrollableAddSemanticIndexesLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorLabel.
  ///
  /// In en, this message translates to:
  /// **'Keyboard dismiss behavior'**
  String get storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorManualLabel.
  ///
  /// In en, this message translates to:
  /// **'Manual'**
  String get storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorManualLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorOnDragLabel.
  ///
  /// In en, this message translates to:
  /// **'On drag'**
  String get storybookWidgetShowcaseOptionScrollableKeyboardDismissBehaviorOnDragLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableHitTestBehaviorLabel.
  ///
  /// In en, this message translates to:
  /// **'Hit test behavior'**
  String get storybookWidgetShowcaseOptionScrollableHitTestBehaviorLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableHitTestBehaviorDeferToChildLabel.
  ///
  /// In en, this message translates to:
  /// **'Defer to child'**
  String get storybookWidgetShowcaseOptionScrollableHitTestBehaviorDeferToChildLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableHitTestBehaviorOpaqueLabel.
  ///
  /// In en, this message translates to:
  /// **'Opaque'**
  String get storybookWidgetShowcaseOptionScrollableHitTestBehaviorOpaqueLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableHitTestBehaviorTranslucentLabel.
  ///
  /// In en, this message translates to:
  /// **'Translucent'**
  String get storybookWidgetShowcaseOptionScrollableHitTestBehaviorTranslucentLabel;

  /// No description provided for @storybookWidgetShowcaseOptionScrollableSingleChildScrollableItemLabel.
  ///
  /// In en, this message translates to:
  /// **'Single child scrollable item {index}'**
  String storybookWidgetShowcaseOptionScrollableSingleChildScrollableItemLabel(int index);

  /// No description provided for @storybookWidgetShowcaseOptionScrollableListScrollableItemLabel.
  ///
  /// In en, this message translates to:
  /// **'List scrollable item {index}'**
